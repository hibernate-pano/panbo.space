...
export default withMermaid({
  ...
  head: [
    ...
    ['meta', { property: 'og:image', content: 'https://www.panbo.space/og-image.svg' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:image', content: 'https://www.panbo.space/og-image.svg' }],
  ],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '[银行] HSBC', link: '/coding/HSBC/汇丰入职指南' },
      { text: '关于', link: '/about' }
    ],
