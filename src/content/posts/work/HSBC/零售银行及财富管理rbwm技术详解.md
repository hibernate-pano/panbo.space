...
public class AmlMonitorService {
    ...
    /**
     * 检查交易是否触发大额报告
     * [修订注: 原注释“单笔50万或累计100万”不符合中国反洗钱规定——
     *  个人转账单笔/当日累计等值5万美元以上（约30-50万人民币）、
     *  企业转账单笔/当日累计等值20万美元以上需向反洗钱监测中心报告，
     *  具体阈值以央行《金融机构大额交易和可疑交易报告管理办法》最新规定为准。
     *  下方 500000 仅为教学示意，不代表真实监管阈值。]
     */
    public boolean needLargeTransactionReport(BigDecimal amount) {
        // 大额标准（示例值，非真实监管阈值）：见上方修订注
