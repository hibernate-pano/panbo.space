---
title: 汇丰 Senior Full-Stack Developer 的技术栈与思考
summary: >-
  在外界眼中，银行的技术团队往往被贴上"保守"、"老旧"的标签。诚然，银行业确实存在大量运行了几十年的核心系统（Core Banking），这些系统大多基于
  COBOL、Oracle Forms 等传统技术，承载着数十年的业务逻辑和监管积累。
