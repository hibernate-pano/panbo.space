...
summary: 详解 Istio 架构、mTLS 双向认证、金丝雀流量管理、可观测性配置，以及在 HSBC 银行系统中替代传统 Sidecar 的实战经验。
...
featured: false
draft: false
slug: kubernetes-istio银行servicemesh实战
legacyPaths:
  - /coding/DevOps/Kubernetes-Istio银行ServiceMesh实战
---
