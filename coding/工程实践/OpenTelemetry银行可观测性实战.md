...
date: 2026-03-21
description: 从手动埋点到 OpenTelemetry 全自动插桩，详解银行分布式系统的可观测性体系设计：链路追踪、指标体系、日志关联，以及与 Jaeger/Prometheus/Grafana 的集成。
---

# OpenTelemetry 银行可观测性实战：Tracing、Metrics、Logs 统一实践
