---
title: Spring Boot 数据库连接池调优：从配置到生产实战
summary: 在我参与过的多个 Spring Boot 项目中，连接池配置几乎都是"上线前随便设，出问题再调"。这种做法在互联网公司或许可以接受，但在银行业——
...
featured: false
draft: false
slug: springboot数据库连接池调优
legacyPaths:
  - /coding/Java/SpringBoot数据库连接池调优
---
