...
summary: >-
  从 Liveness、Readiness、Startup 三大探针原理到 Spring Boot Actuator 自定义健康指标，详解银行 K8s
  生产环境中 Pod 健康检查的完整配置与避坑指南。
...
featured: false
draft: false
slug: kubernetes探针与健康检查-springboot-actuator集成
legacyPaths:
  - /coding/Kubernetes/Kubernetes探针与健康检查-SpringBoot Actuator集成
---
